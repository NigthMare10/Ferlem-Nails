...
- Historial de Facturas: correccion puntual aplicada con busqueda visible por folio/atendido por/estado/monto, Ver Factura real, Exportar CSV funcional, engranaje con Salir y sin botones muertos de pendientes o reembolsos.
...
- Las pantallas Stitch genericas en iframe siguen dependiendo de mejoras inyectadas en `resources/js/Pages/Stitch/Frame.tsx`; para esta iteracion solo se toco puntualmente Detalle de Factura Digital y Historial de Facturas.
...
- En esta correccion puntual se reparo Historial de Facturas con datos reales, busqueda visible, acceso a factura digital, exportacion CSV, engranaje con Salir y navegacion util hacia Analitica e Historial.
...
- No tocar el flujo normal salvo los puntos puntuales pedidos para Detalle de Factura Digital e Historial de Facturas.
